...
//	
	...
	public Customer reserveCar(int id, Customer cust, String location)
		throws RemoteException
	{
	...
	public Customer reserveRoom(int id, Customer cust, String location)
		throws RemoteException
	{
		return reserveItem(id, cust, Hotel.getKey(location), location);
	}
	// Adds flight reservation to this customer.  
	public Customer reserveFlight(int id, Customer cust, int flightNum)
		throws RemoteException
	{
		return reserveItem(id, cust, Flight.getKey(flightNum), String.valueOf(flightNum));
	}
